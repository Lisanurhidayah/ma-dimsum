...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "M.A. Dimsum Semarang — Dimsum Ayam Homemade Fresh Setiap Hari" },
      { name: "description", content: "Pesan dimsum ayam original, mentai, salted egg, dan goreng khas Semarang. Homemade, fresh, pengiriman cepat via WhatsApp." },
      { property: "og:title", content: "M.A. Dimsum Semarang" },
      { property: "og:description", content: "Dimsum ayam homemade fresh khas Semarang." },
